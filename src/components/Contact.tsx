...
export default function Contact() {
  ...
  const handleWhatsApp = () => {
    ...
    window.open(`https://wa.me/628111234567?text=${encodeURIComponent(msg)}`, '_blank')
  }

  return (
    <section id="contact" className="py-28 relative overflow-hidden bg-[#0f0e0c]" ref={ref}>
      {/* Background */}
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className={`text-center mb-16 transition-all duration-800 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="ornament-divider mb-6">
            <span className="text-[#c8a96e] text-xs tracking-[0.4em] uppercase">Hubungi Kami</span>
          </div>
          ...
          <p className="text-white/50 max-w-md mx-auto font-light">
            Tim kami siap membantu Anda menemukan unit yang paling sesuai dengan kebutuhan dan anggaran Anda.
          </p>
        </div>

        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 transition-all duration-800 delay-200 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {/* Contact form */}
          <div className="bg-[#1a1814] border border-white/5 p-8">
            <div className="text-[#c8a96e] text-xs tracking-[0.4em] uppercase mb-6">Formulir Konsultasi</div>

            <div className="space-y-4">
              <div>
                <label className="text-white/40 text-xs tracking-widest uppercase block mb-2">Nama Lengkap</label>
                <input
                  type="text"
                  value={form.name}
              ...
              <div>
                <label className="text-white/40 text-xs tracking-widest uppercase block mb-2">Nomor WhatsApp</label>
                <input
                  type="tel"
                  value={form.phone}
              ...
              <div>
                <label className="text-white/40 text-xs tracking-widest uppercase block mb-2">Pesan (Opsional)</label>
                <textarea
                  value={form.message}
          ...
          <div className="flex flex-col justify-between gap-6">
            {/* Direct contacts */}
            <div className="space-y-4">
              <div className="text-[#c8a96e] text-xs tracking-[0.4em] uppercase mb-6">Kontak Langsung</div>
            ...
            >
              ...
              <div>
                <div className="font-display text-xl font-light">Chat WhatsApp Sekarang</div>
                <div className="text-xs tracking-widest uppercase opacity-60">Respon Cepat & Gratis</div>
              </div>
            </a>
          </div>
        </div>
