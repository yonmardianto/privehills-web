...
const units = [
  {
    ...
    specs: {
      ...
      dindingKamarMandi: "Keramik Roman 25x50 cm",
  ...
  },
  {
    ...
    specs: {
      ...
      struktur: "Beton bertulang",
      dinding: "Bata Merah Finishing Plester Aci & Cat",
      dindingKamarMandi: "Keramik Roman 60x60 cm",
      penutupAtap: "Spandek pasir",
      rangkaAtap: "Baja Ringan",
      plafon: "Gypsum board",
      lantaiUtamaDanRuangTidur: "Homogeneous Tile 60x60 cm",
      lantaiKamarMandi: "Keramik Roman 60x60 cm",
      carport: "Rabat Beton + Tali Air",
...

  {
    ...
    specs: {
      ...
      struktur: "Beton bertulang",
      dinding: "Bata Merah Finishing Plester Aci & Cat",
      dindingKamarMandi: "Keramik Roman 60x60",
      penutupAtap: "Genteng Flat Kanmuri Silk Black",
      rangkaAtap: "Baja Ringan",
      plafon: "Gypsum board",
      lantaiUtamaDanRuangTidur: "Homogeneous Tile 60x60 cm",
      lantaiKamarMandi: "Keramik Roman 60x60",
      carport: "Rabat Beton + Tali Air",
