...
const units = [
  {
    ...
    specs: {
      ...
      dindingKamarMandi: "Keramik Roman 25x50",
      penutupAtap: "Spandek pasir",
      rangkaAtap: "Baja Ringan",
      plafon: "Gypsum board",
      lantaiUtamaDanRuangTidur: "Homogeneous Tile 60x60",
      lantaiKamarMandi: "Keramik Roman 25x25",
  ...
  },
  {
    ...
    specs: {
      ...
      struktur: "Beton bertulang",
      dinding: "Bata Merah Finishing Plester Aci & Cat",
      dindingKamarMandi: "Homogeneous Tile 60x60",
      penutupAtap: "Spandek pasir",
      rangkaAtap: "Baja Ringan",
      plafon: "Gypsum board",
      lantaiUtamaDanRuangTidur: "Homogeneous Tile 60x60",
      lantaiKamarMandi: "Homogeneous Tile 60x60",
      carport: "Rabat Beton + Tali Air",
...
export default function Units() {
  ...
  return (
    <section id="units-hunian" className="py-20 bg-[#111009]" ref={ref}>
