...
const stats = [
  { value: '150+', label: 'Unit Tersedia' },
  { value: '3', label: 'Tipe Unit' },
...
export default function Stats() {
  ...
  return (
    <section className="relative bg-[#1a1814] border-y border-white/5 py-0" ref={ref}>
      {/* Gold top line */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="text-white/30 text-xs tracking-[0.3em] uppercase">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
