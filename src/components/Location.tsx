...
const landmarks = [
  { category: 'Transportasi', items: ['30 menit ke Bandara Soekarno Hatta', '10 menit ke Gerbang Tol Pamulang', '20 menit ke Stasiun Jurangmangu', '15 menit ke Stasiun Rawa Buntu'] },
  { category: 'Pendidikan', items: ['Universitas Pamulang (5 menit)', 'SMAN Pamulang (7 menit)', 'Sekolah Internasional (10 menit)', 'Institut Teknologi BSD (15 menit)'] },
  { category: 'Komersial', items: ['Pamulang Square (5 menit)', 'Living World (12 menit)', 'Transmart (8 menit)', 'AEON Mall (20 menit)'] },
  { category: 'Kesehatan', items: ['RS Pondok Indah (15 menit)', 'RS Ciputra (10 menit)', 'Klinik & Apotek (3 menit)', 'Puskesmas (5 menit)'] },
]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className={`text-center mb-16 transition-all duration-800 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="ornament-divider mb-6">
            <span className="text-[#c8a96e] text-xs tracking-[0.4em] uppercase">Lokasi Strategis</span>
          </div>
          ...
          <p className="text-white/50 max-w-2xl mx-auto font-light leading-relaxed">
            Berlokasi di kawasan perbukitan Pamulang yang strategis, terhubung mudah 
            dengan berbagai pusat aktivitas Jabodetabek.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className={`transition-all duration-800 delay-200 ${visible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            <div className="relative">
              ...
              <div className="w-full h-96 relative overflow-hidden border border-white/10">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.8219999999997!2d106.71!3d-6.35!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMjEnMDAuMCJTIDEwNsKwNDInMzYuMCJF!5e0!3m2!1sid!2sid!4v1234567890"
                  width="100%"
                  height="100%"
            ...
            <div className="mt-4 bg-[#1a1814] border border-white/5 p-5 flex items-start gap-4">
              ...
              <div>
                <div className="text-white font-display text-base font-light mb-1">Privé Hills Residence</div>
                <div className="text-white/50 text-sm font-light">Pamulang, Tangerang Selatan, Banten, Indonesia</div>
                <a
          ...
          {/* Landmarks */}
          <div className={`transition-all duration-800 delay-400 ${visible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
            {/* Category tabs */}
            ...
            <div className="grid grid-cols-3 gap-3 mt-8">
              {[
                ...
                <div key={i} className="text-center border border-[#c8a96e]/20 py-5 px-3">
                  <div className="font-display text-xl text-[#c8a96e] font-light">{s.value}</div>
