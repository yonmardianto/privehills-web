...
export const metadata: Metadata = {
  ...
  description: 'Privé Hills Residence – hunian minimalis modern di perbukitan Pamulang, Tangerang Selatan. Harga mulai Rp1,41 Miliar.',
  keywords: 'rumah pamulang, privé hills residence, perumahan tangerang selatan, hunian modern',
  openGraph: {
